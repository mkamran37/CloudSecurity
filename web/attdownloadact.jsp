...
<div id="topbar">
  <div class="wrapper">
    <div id="topnav">
      <ul>
          <li><a href="attackerseasrch.jsp">Search Keys</a></li>
       
        <li class="active"><a href="attdownload.jsp">Generate Key</a></li>
...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
                   <%
                    ...
                    %>
                    <center> 
                        <h2> Cloud-A Key Verification System</h2>
                            <form action="attverify.jsp" method="post">
