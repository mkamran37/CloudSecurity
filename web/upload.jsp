  ...
  <div class="wrapper">
    <div id="topnav">
      <ul>
       ...
       <li class="active"><a href="publiccloud.jsp">upload to cloud</a></li>
...
try{ 
	...
	PreparedStatement pst=con.prepareStatement("select * from keygen where owner='"+user+"' and privatekey != 'no' ");
   
	ResultSet rs=pst.executeQuery();
        %>
        
        <center>   <table style="width:60%" border="5">
...
        <th><font color="red">File Content</font></th>
      
        <th><font color="red">Owner</font></th>
            <th><font color="red">Upload to Cloud</font></th>
...
<%
	...
	while(rs.next()){
            %><tr><th><%=rs.getString(1)%></th>
                ...
                <th><a href="uploadcloud.jsp?<%=rs.getString(1)%>">Upload to Cloud</a></th>
        </tr>
