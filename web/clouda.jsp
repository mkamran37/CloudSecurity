  ...
  <div class="wrapper">
    <div id="topnav">
      <ul>
        ...
        <li class="active"><a href="clouda.jsp">Cloud-A</a></li>
...
<br><br><br>    
          ...
          <div class="featured_tab"> <img src="img/log3.jpg" alt="" />
            <p>Cloud--A--Login</p>
          </div>
        </li>
  ...
  <div class="wrapper">
    <div id="content">
      <h2>About Login</h2>
       ...
       <p>Cloud-A has to enter valid username and password.PC Home page will be displayed if login Successfully.</p>
