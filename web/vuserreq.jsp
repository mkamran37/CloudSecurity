  ...
  <div class="wrapper">
    <div id="topnav">
      <ul>
       ...
       <li class="active"><a href="vuserreq.jsp">view user request</a></li>
...
<%
  ...
  <%--               <th><%=rs.getString(2)%></th>   --%>
               ...
               <th><a href="response.jsp?filename=<%=rs.getString("filename")%>&data=<%=rs.getString("data")%>&owner=<%=rs.getString("owner")%>&email=<%=rs.getString("email")%>" >Send Key</a></th> 
