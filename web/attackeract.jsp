  ...
  <div class="wrapper">
    <div id="topnav">
      <ul>
        ...
        <li class="active"><a href="attackerseasrch.jsp">Search Keys</a></li>
       
        <li><a href="attdownload.jsp">Generate Key</a></li>
...
try{ 
	...
	ResultSet rs=pst.executeQuery();
        ...
        <center>   <table style="width:40%" border="5">
         
  <tr>
    <th><font color="red">Privatekeys</font></font></th>
...
<div id="copyright">
  <div class="wrapper">
    ...
    <p class="fl_right">Template by <a target="_blank" href="http://1000projects.org//" title="Free Website Templates">1000 Projects</a></p>
    <br class="clear" />
  </div>
</div>
</body>
