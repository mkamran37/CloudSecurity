  ...
  <div class="wrapper">
    <div id="topnav">
      <ul>
       ...
       <li class="active"><a href="cloudb.jsp">Cloud-B</a></li>
...
<br><br><br>    
          ...
          <div class="featured_tab"> <img src="img/login.jpg" alt="" />
            <p>Cloud--B--Login</p>
          </div>
        </li>
  ...
  <div class="wrapper">
    <div id="content">
      <h2>About Login</h2>
       ...
       <p>PC has to enter valid username and password.PC Home page will be displayed if login Successfully.</p>
